...
└── README.md           # This file
Usage
Allocate Memory: Enter a size in bytes and click "Allocate"
Reallocate: Enter a new size and click "Reallocate" (requires an active allocation)
Free Memory: Click "Free Memory" to release the current allocation
View Results: Check the results panel for pointer address, alignment status, and modulus proof
Monitor Actions: View the action log for a history of operations
Visualize: See current allocations in the visualization section
Notes
